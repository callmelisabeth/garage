 ...
 */
final class Version20231123122041 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE services ADD title VARCHAR(60) NOT NULL, ADD content TEXT NOT NULL, DROP user_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE services ADD user_id INT DEFAULT NULL, DROP title, DROP content');
